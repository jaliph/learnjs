...
NumMatrix.prototype.sumRegion = function (row1, col1, row2, col2) {
  ...
  const downRight = this.sumArray[row2][col2]
  const topLeft = this.sumArray[row1 - 1][col1 - 1]
  const up = this.sumArray[row1 - 1][col2]
  const left = this.sumArray[row2][col1 - 1]
