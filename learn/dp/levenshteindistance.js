const levenshteinDistance = function (str1, str2) {
  ...
  const levenshteinDistanceRecur = (str1, str2) => {
    ...
    const c1 = levenshteinDistanceRecur(str1.substring(0, str1.length - 1), str2) + 1 // deletion of 1 char from string 1
    const c2 = levenshteinDistanceRecur(str1, str2.substring(0, str2.length - 1)) + 1 // deletion of 1 char from string 2
    const c3 = levenshteinDistanceRecur(str1.substring(0, str1.length - 1), str2.substring(0, str2.length - 1)) + 1 // replacement
