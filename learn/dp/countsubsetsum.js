...
const recusrsioncountSubsetSum = (arr, i, sum) => {
  ...
  const ithNumSelected = recusrsioncountSubsetSum(arr, i - 1, sum - arr[i - 1])
  const ithNumNotSelected = recusrsioncountSubsetSum(arr, i - 1, sum)
...
const countsubset2 = (arr, target) => {
  const countSubSetR = (arr, target, i) => {
