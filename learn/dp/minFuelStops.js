...
const minRefuelStopsBrute = (T, sFuel, stations) => {
  ...
  const minRefuelStopsRecur = (index, used, curFuel, stations) => {
    ...
    // if not fueled
    let result1 = minRefuelStopsRecur(index - 1, used, curFuel, stations)


    // if fueled
    let result2 = minRefuelStopsRecur(index - 1, used - 1, curFuel, stations)
...
function main(){
    var target = [3, 120, 15, 570, 1360];
    var startFuel = [3, 10, 3, 140, 380];
    var stations = [[], 
