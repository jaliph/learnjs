...
const stockPricesData = [[1, 2, 3, 4, 3, 2, 1, 2, 5], [8, 6, 5, 4, 3, 2, 1], [12, 30, 40, 90, 110], [2]]

for (let i = 0; i < stockPricesData.length; i++) {
  const result = findBuySellStockPrices(stockPricesData[i])
